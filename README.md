...
specs/               ← Spec Writer 출력 (예: specs/auth-login.md)
...
| 기존 규칙 | 하네스 내 위치 |
|---|---|
| SCOPE (병렬 탐색, haiku) | /spec Step 2 + /generate Step 1 |
| PLAN (todo.md) | /spec의 specs/{title}.md로 대체 |
